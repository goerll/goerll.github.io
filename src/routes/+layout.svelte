...
<div class="relative min-h-screen overflow-hidden bg-background">
	...
	{#if usesSideBands($page.url.pathname)}
		<div
			class="pointer-events-none absolute inset-y-0 inset-x-0 z-10 bg-card/38 backdrop-blur-2xl xl:left-1/2 xl:right-auto xl:-translate-x-1/2 xl:border-x xl:border-border/55"
